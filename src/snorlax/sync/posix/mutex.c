...
static int32_t sync_posix_func_unlock(sync_posix_t * sync);
static int32_t sync_posix_func_wait(sync_posix_t * sync, int64_t second, int64_t nano);
static int32_t sync_posix_func_wakeup(sync_posix_t * sync, int32_t all);

static sync_posix_func_t func = {
    sync_posix_func_rem,
    sync_posix_func_lock,
    sync_posix_func_unlock,
    sync_posix_func_wait,
    sync_posix_func_wakeup
};

extern sync_posix_t * sync_posix_gen(void) {
    sync_posix_t * sync = (sync_posix_t *) calloc(1, sizeof(sync_posix_t));
